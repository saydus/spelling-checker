...
const Routes = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<div class="${"container"}"><header class="${"navbar"}"><ul class="${"navbar-nav flex-row ml-md-auto d-none d-md-flex"}"><a href="${"/"}" class="${"btn btn-bd-download d-none d-lg-inline-block add-item"}">Add Words 
		</a></ul></header>
	...
	<div id="${"accordion"}"><div class="${"card"}"><div class="${"card-header"}" id="${"headingOne"}"><h5 class="${"mb-0"}"><a class="${"btn btn-link svelte-onxtnb"}" data-toggle="${"collapse"}" data-target="${"#collapseOne"}" aria-expanded="${"true"}" aria-controls="${"collapseOne"}">Words entered:</a></h5></div>
