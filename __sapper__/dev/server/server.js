...
const Routes = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	$$result.css.add(css);
	let formatted_words = formatWords(input);
	...
	<div id="${"accordion"}"><div class="${"card"}"><div class="${"card-header"}" id="${"headingOne"}"><h5 class="${"mb-0"}"><span class="${"btn btn-link svelte-1fpog53"}" data-toggle="${"collapse"}" data-target="${"#collapseOne"}" aria-expanded="${"true"}" aria-controls="${"collapseOne"}">Words entered:</span></h5></div>
	...
	? `${escape(formatted_words.map(word => " " + word))}`
