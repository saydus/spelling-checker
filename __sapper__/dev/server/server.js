...
const Routes = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	<div id="${"accordion"}"><div class="${"card"}"><div class="${"card-header"}" id="${"headingOne"}"><h5 class="${"mb-0"}"><span class="${"btn btn-link svelte-dap1bh"}" data-toggle="${"collapse"}" data-target="${"#collapseOne"}" aria-expanded="${"true"}" aria-controls="${"collapseOne"}">Words entered:</span></h5></div>
...
const Add = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
    ...
    <div class="${"input-group"}"><div class="${"input-group-prepend"}"><span></span></div>
        <textarea class="${"form-control"}" aria-label="${"With textarea"}" placeholder="${"Enter your words or text."}">${ ""}</textarea></div> 

    <div class="${"form-group"}"><label for="${"exampleFormControlFile1"}">File with words or text</label>
    <input type="${"file"}" class="${"form-control-file"}" id="${"exampleFormControlFile1"}"></div>

    <div class="${"button-container text-center"}"><input type="${"submit"}" class="${"btn btn-outline-primary text-center check-button"}" value="${"Add Words"}"></div>
...
unwrapExports(node);
var node_1 = node.TrieNode;

var trie = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
exports.Trie = void 0;

class Trie {
    constructor() {
        this.root = new node.TrieNode();
    }
    /**
    ...
    insert(word) {
        ...
        for (const char of word) {
            ...
            if (children.get(char)) {
                node$1 = children.get(char);
            }
            else {
                node$1 = new node.TrieNode(char);
                children.set(char, node$1);
            }
            if (node$1) {
...
var Trie = unwrapExports(trie);
var trie_1 = trie.Trie;
