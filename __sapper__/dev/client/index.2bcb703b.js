import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, v as validate_slots, g as globals, e as element, t as text, a as space, c as claim_element, b as children, f as claim_text, h as detach_dev, j as claim_space, k as attr_dev, l as add_location, m as insert_dev, n as append_dev, o as set_input_value, p as listen_dev, q as set_data_dev, r as noop, u as run_all } from './client.a738ede3.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(span1, file, 126, 4, 2559);
			attr_dev(h51, "class", "mb-0");
			add_location(h51, file, 125, 3, 2537);
			attr_dev(div5, "class", "card-header");
			attr_dev(div5, "id", "headingOne");
			add_location(div5, file, 124, 3, 2492);
			attr_dev(div6, "class", "card-body");
			add_location(div6, file, 131, 3, 2832);
			...
			add_location(div7, file, 130, 3, 2730);
			attr_dev(div8, "class", "card");
			add_location(div8, file, 123, 2, 2470);
			attr_dev(div9, "id", "accordion");
			add_location(div9, file, 122, 1, 2447);
			attr_dev(div10, "class", "container");
			add_location(div10, file, 80, 0, 1259);
		},
		m: function mount(target, anchor) {
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$inject_state = $$props => {
		...
		if ("incorrectWords" in $$props) incorrectWords = $$props.incorrectWords;
