import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, v as validate_slots, e as element, t as text, a as space, c as claim_element, b as children, f as claim_text, g as detach_dev, h as claim_space, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, n as set_input_value, o as listen_dev, p as set_data_dev, q as noop, r as run_all } from './client.c31bac5f.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a1, file, 101, 4, 2006);
			attr_dev(h51, "class", "mb-0");
			add_location(h51, file, 100, 3, 1984);
			attr_dev(div5, "class", "card-header");
			attr_dev(div5, "id", "headingOne");
			add_location(div5, file, 99, 3, 1939);
			attr_dev(div6, "class", "card-body");
			add_location(div6, file, 106, 3, 2273);
			...
			add_location(div7, file, 105, 3, 2171);
			attr_dev(div8, "class", "card");
			add_location(div8, file, 98, 2, 1917);
			attr_dev(div9, "id", "accordion");
			add_location(div9, file, 97, 1, 1894);
			attr_dev(div10, "class", "container");
			add_location(div10, file, 52, 0, 702);
		},
		m: function mount(target, anchor) {
