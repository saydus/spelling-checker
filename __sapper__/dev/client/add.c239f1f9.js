import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, v as validate_slots, e as element, t as text, c as claim_element, a as children, b as claim_text, f as detach_dev, h as attr_dev, j as add_location, k as insert_dev, l as append_dev, m as add_render_callback, n as create_bidirectional_transition, o as space, p as claim_space, u as set_input_value, w as listen_dev, x as transition_in, y as transition_out, A as run_all, C as noop, q as set_data_dev } from './client.fd4f4a88.js';
import { s as slide, f as fade } from './index.e01d43ee.js';
...
function create_if_block(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(123:4) {#if input.length != 0}",
		ctx
	});
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(span, file, 93, 12, 1907);
			attr_dev(div0, "class", "input-group-prepend");
			add_location(div0, file, 92, 12, 1861);
			...
			add_location(a1, file, 116, 4, 2732);
			attr_dev(h5, "class", "mb-0");
			add_location(h5, file, 115, 3, 2710);
			attr_dev(div4, "class", "card-header");
			attr_dev(div4, "id", "headingOne");
			add_location(div4, file, 114, 3, 2665);
			attr_dev(div5, "class", "card-body");
			add_location(div5, file, 121, 3, 2999);
			...
			add_location(div6, file, 120, 3, 2897);
			attr_dev(div7, "class", "card");
			add_location(div7, file, 113, 2, 2643);
			attr_dev(div8, "id", "accordion");
			add_location(div8, file, 112, 1, 2620);
