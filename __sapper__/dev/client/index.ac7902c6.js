import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, v as validate_slots, g as globals, e as element, t as text, a as space, c as claim_element, b as children, f as claim_text, h as detach_dev, j as claim_space, k as attr_dev, l as add_location, m as insert_dev, n as append_dev, o as set_input_value, p as listen_dev, q as set_data_dev, r as noop, u as run_all } from './client.ae7280f4.js';
...
function create_if_block(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(126:4) {#if input.length != 0}",
		ctx
	});
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a1, file, 119, 4, 2604);
			attr_dev(h51, "class", "mb-0");
			add_location(h51, file, 118, 3, 2582);
			attr_dev(div5, "class", "card-header");
			attr_dev(div5, "id", "headingOne");
			add_location(div5, file, 117, 3, 2537);
			attr_dev(div6, "class", "card-body");
			add_location(div6, file, 124, 3, 2871);
			...
			add_location(div7, file, 123, 3, 2769);
			attr_dev(div8, "class", "card");
			add_location(div8, file, 116, 2, 2515);
			attr_dev(div9, "id", "accordion");
			add_location(div9, file, 115, 1, 2492);
			attr_dev(div10, "class", "container");
			add_location(div10, file, 73, 0, 1304);
		},
		m: function mount(target, anchor) {
