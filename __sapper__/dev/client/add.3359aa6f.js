import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, v as validate_slots, e as element, t as text, c as claim_element, a as children, b as claim_text, f as detach_dev, h as attr_dev, j as add_location, k as insert_dev, l as append_dev, m as add_render_callback, n as create_bidirectional_transition, o as space, p as claim_space, u as set_input_value, w as listen_dev, x as transition_in, y as transition_out, A as run_all, C as noop, q as set_data_dev } from './client.72aef67d.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a1, file, 114, 4, 2593);
			attr_dev(h5, "class", "mb-0");
			add_location(h5, file, 113, 3, 2571);
			attr_dev(div4, "class", "card-header");
			attr_dev(div4, "id", "headingOne");
			add_location(div4, file, 112, 3, 2526);
			attr_dev(div5, "class", "card-body");
			add_location(div5, file, 119, 3, 2860);
			...
			add_location(div6, file, 118, 3, 2758);
			attr_dev(div7, "class", "card");
			add_location(div7, file, 111, 2, 2504);
			attr_dev(div8, "id", "accordion");
			add_location(div8, file, 110, 1, 2481);
