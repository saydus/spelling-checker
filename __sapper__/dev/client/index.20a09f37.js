import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, v as validate_slots, e as element, t as text, a as space, c as claim_element, b as children, f as claim_text, g as detach_dev, h as claim_space, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, n as set_input_value, o as listen_dev, p as set_data_dev, q as noop, r as run_all } from './client.eb1f1ea4.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a0, file, 72, 2, 1576);
			attr_dev(ul, "class", "navbar-nav flex-row ml-md-auto d-none d-md-flex");
			add_location(ul, file, 70, 2, 1511);
			attr_dev(header, "class", "navbar");
			add_location(header, file, 69, 1, 1485);
			...
			add_location(a1, file, 116, 4, 2747);
			attr_dev(h51, "class", "mb-0");
			add_location(h51, file, 115, 3, 2725);
			attr_dev(div5, "class", "card-header");
			attr_dev(div5, "id", "headingOne");
			add_location(div5, file, 114, 3, 2680);
			attr_dev(div6, "class", "card-body");
			add_location(div6, file, 121, 3, 3014);
			...
			add_location(div7, file, 120, 3, 2912);
			attr_dev(div8, "class", "card");
			add_location(div8, file, 113, 2, 2658);
			attr_dev(div9, "id", "accordion");
			add_location(div9, file, 112, 1, 2635);
			attr_dev(div10, "class", "container");
			add_location(div10, file, 67, 0, 1443);
		},
		m: function mount(target, anchor) {
