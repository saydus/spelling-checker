import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, v as validate_slots, g as globals, e as element, t as text, a as space, c as claim_element, b as children, f as claim_text, h as detach_dev, j as claim_space, k as attr_dev, l as add_location, m as insert_dev, n as append_dev, o as set_input_value, p as listen_dev, q as set_data_dev, r as noop, u as run_all } from './client.3717730d.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a1, file, 120, 4, 2680);
			attr_dev(h51, "class", "mb-0");
			add_location(h51, file, 119, 3, 2658);
			attr_dev(div5, "class", "card-header");
			attr_dev(div5, "id", "headingOne");
			add_location(div5, file, 118, 3, 2613);
			attr_dev(div6, "class", "card-body");
			add_location(div6, file, 125, 3, 2947);
			...
			add_location(div7, file, 124, 3, 2845);
			attr_dev(div8, "class", "card");
			add_location(div8, file, 117, 2, 2591);
			attr_dev(div9, "id", "accordion");
			add_location(div9, file, 116, 1, 2568);
			attr_dev(div10, "class", "container");
			add_location(div10, file, 74, 0, 1380);
		},
		m: function mount(target, anchor) {
