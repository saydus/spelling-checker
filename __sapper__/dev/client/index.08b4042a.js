import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, v as validate_slots, g as globals, e as element, t as text, a as space, c as claim_element, b as children, f as claim_text, h as detach_dev, j as claim_space, k as attr_dev, l as add_location, m as insert_dev, n as append_dev, o as set_input_value, p as listen_dev, q as set_data_dev, r as noop, u as run_all } from './client.bbe5d0dd.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(span1, file, 126, 4, 2637);
			attr_dev(h51, "class", "mb-0");
			add_location(h51, file, 125, 3, 2615);
			attr_dev(div5, "class", "card-header");
			attr_dev(div5, "id", "headingOne");
			add_location(div5, file, 124, 3, 2570);
			attr_dev(div6, "class", "card-body");
			add_location(div6, file, 131, 3, 2910);
			...
			add_location(div7, file, 130, 3, 2808);
			attr_dev(div8, "class", "card");
			add_location(div8, file, 123, 2, 2548);
			attr_dev(div9, "id", "accordion");
			add_location(div9, file, 122, 1, 2525);
			attr_dev(div10, "class", "container");
			add_location(div10, file, 80, 0, 1328);
		},
		m: function mount(target, anchor) {
