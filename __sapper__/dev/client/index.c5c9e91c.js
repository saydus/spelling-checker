import { i as identity, S as SvelteComponentDev, a as init, d as dispatch_dev, s as safe_not_equal, v as validate_slots, g as globals, e as element, t as text, c as claim_element, b as children, f as claim_text, h as detach_dev, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, n as add_render_callback, o as create_bidirectional_transition, p as space, q as claim_space, r as set_data_dev, u as prop_dev, w as set_input_value, x as listen_dev, y as transition_in, z as transition_out, A as check_outros, B as run_all, C as group_outros, D as noop } from './client.a4cc8035.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(span1, file, 141, 4, 3024);
			attr_dev(h5, "class", "mb-0");
			add_location(h5, file, 140, 3, 3002);
			attr_dev(div3, "class", "card-header");
			attr_dev(div3, "id", "headingOne");
			add_location(div3, file, 139, 3, 2957);
			attr_dev(div4, "class", "card-body");
			add_location(div4, file, 146, 3, 3297);
			...
			add_location(div5, file, 145, 3, 3195);
			attr_dev(div6, "class", "card");
			add_location(div6, file, 138, 2, 2935);
			attr_dev(div7, "id", "accordion");
			add_location(div7, file, 137, 1, 2912);
