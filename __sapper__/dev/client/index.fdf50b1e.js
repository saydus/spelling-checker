...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a1, file, 121, 4, 2857);
			attr_dev(h51, "class", "mb-0");
			add_location(h51, file, 120, 3, 2835);
			attr_dev(div5, "class", "card-header");
			attr_dev(div5, "id", "headingOne");
			add_location(div5, file, 119, 3, 2790);
			attr_dev(div6, "class", "card-body");
			add_location(div6, file, 126, 3, 3124);
			...
			add_location(div7, file, 125, 3, 3022);
			attr_dev(div8, "class", "card");
			add_location(div8, file, 118, 2, 2768);
			attr_dev(div9, "id", "accordion");
			add_location(div9, file, 117, 1, 2745);
			attr_dev(div10, "class", "container");
			add_location(div10, file, 72, 0, 1546);
		},
		m: function mount(target, anchor) {
