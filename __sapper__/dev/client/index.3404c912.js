import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, v as validate_slots, e as element, t as text, a as space, c as claim_element, b as children, f as claim_text, g as detach_dev, h as claim_space, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, n as set_input_value, o as listen_dev, p as set_data_dev, q as noop, r as run_all } from './client.cd20c997.js';
...
function create_if_block(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(112:4) {#if input.length != 0}",
		ctx
	});
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a1, file, 105, 4, 2010);
			attr_dev(h51, "class", "mb-0");
			add_location(h51, file, 104, 3, 1988);
			attr_dev(div5, "class", "card-header");
			attr_dev(div5, "id", "headingOne");
			add_location(div5, file, 103, 3, 1943);
			attr_dev(div6, "class", "card-body");
			add_location(div6, file, 110, 3, 2277);
			...
			add_location(div7, file, 109, 3, 2175);
			attr_dev(div8, "class", "card");
			add_location(div8, file, 102, 2, 1921);
			attr_dev(div9, "id", "accordion");
			add_location(div9, file, 101, 1, 1898);
			attr_dev(div10, "class", "container");
			add_location(div10, file, 56, 0, 706);
		},
		m: function mount(target, anchor) {
