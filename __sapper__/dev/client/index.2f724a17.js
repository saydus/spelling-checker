...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a1, file, 124, 4, 2941);
			attr_dev(h51, "class", "mb-0");
			add_location(h51, file, 123, 3, 2919);
			attr_dev(div5, "class", "card-header");
			attr_dev(div5, "id", "headingOne");
			add_location(div5, file, 122, 3, 2874);
			attr_dev(div6, "class", "card-body");
			add_location(div6, file, 129, 3, 3208);
			...
			add_location(div7, file, 128, 3, 3106);
			attr_dev(div8, "class", "card");
			add_location(div8, file, 121, 2, 2852);
			attr_dev(div9, "id", "accordion");
			add_location(div9, file, 120, 1, 2829);
