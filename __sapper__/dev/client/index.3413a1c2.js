import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, v as validate_slots, g as globals, e as element, t as text, a as space, c as claim_element, b as children, f as claim_text, h as detach_dev, j as claim_space, k as attr_dev, l as add_location, m as insert_dev, n as append_dev, o as set_input_value, p as listen_dev, q as set_data_dev, r as noop, u as run_all } from './client.c1328c2a.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(span1, file, 128, 4, 2666);
			attr_dev(h51, "class", "mb-0");
			add_location(h51, file, 127, 3, 2644);
			attr_dev(div5, "class", "card-header");
			attr_dev(div5, "id", "headingOne");
			add_location(div5, file, 126, 3, 2599);
			attr_dev(div6, "class", "card-body");
			add_location(div6, file, 133, 3, 2939);
			...
			add_location(div7, file, 132, 3, 2837);
			attr_dev(div8, "class", "card");
			add_location(div8, file, 125, 2, 2577);
			attr_dev(div9, "id", "accordion");
			add_location(div9, file, 124, 1, 2554);
			attr_dev(div10, "class", "container");
			add_location(div10, file, 82, 0, 1357);
		},
		m: function mount(target, anchor) {
